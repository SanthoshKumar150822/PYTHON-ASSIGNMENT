document.addEventListener("DOMContentLoaded", function () {
  ...
  password.addEventListener("input", () => {
    updateValidationStatus(password,validatePassword(),"Password must be at least 8 characters long.");
    //validateConfirmPassword();
    enableSubmitButton();
  });

  confirmPassword.addEventListener("input", () => {
    //const errorMessage = validateConfirmPassword()? "": "Passwords do not match.";
    updateValidationStatus(confirmPassword, validateConfirmPassword(), "Passwords do not match.");
    enableSubmitButton();
  });

  dateOfBirth.addEventListener("input", () => {
    updateValidationStatus(dateOfBirth,validateDateOfBirth(),"You must be at least 18 years old to register.");
    enableSubmitButton();
  });
